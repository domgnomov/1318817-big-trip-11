...
const createTripItemsContainerTemplate = () => {
  return (
...
const tripControlsSecondElement = tripControlsElement.querySelector(`.visually-hidden:nth-child(2)`);
render(tripControlsFirstElement, createMenuTemplate(), `afterend`);
render(tripControlsSecondElement, createFiltersTemplate(), `afterend`);

const tripEventsElement = document.querySelector(`.trip-events`);
const tripEventsFirstElement = tripEventsElement.querySelector(`.visually-hidden:nth-child(1)`);
render(tripEventsFirstElement, createSortTemplate(), `afterend`);

const tripSortElement = document.querySelector(`.trip-events__trip-sort`);
render(tripSortElement, createTripItemsContainerTemplate(), `afterend`);

const tripItemsContainerElement = document.querySelector(`.trip-days`);
render(tripItemsContainerElement, createTripItemTemplate(), `afterbegin`);
